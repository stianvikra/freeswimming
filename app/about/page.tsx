    ...
    <SiteChrome>
      <PageTemplate size="wide">
        ...
        <div className="mt-6 space-y-5 text-[16px] leading-7 text-slate-700">
          <p>
            This is a free, step-by-step freestyle course for adults who want to feel calm in
            the water, swim longer with less effort, and build real technique — without
            information overload.
          </p>

          <div className="rounded-2xl bg-white/85 p-5 ring-1 ring-slate-100">
            <h2 className="text-[16px] font-semibold text-slate-900">This is for you if…</h2>
          ...
          <div className="rounded-2xl bg-white/85 p-5 ring-1 ring-slate-100">
            <h2 className="text-[16px] font-semibold text-slate-900">What makes this different</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <p>
            If you’re chasing the Olympics, you probably need a different coach. If you’re an adult learner who wants to become a strong, relaxed swimmer — you’re in the right place.
          </p>
        </div>
