  ...
  return (
    <SiteChrome>
      ...
      <PageTemplate showBack={false} withBottomSafeArea={false} topInset="compact">
        <div className="relative overflow-hidden rounded-[22px] border border-blue-100/60 bg-[radial-gradient(560px_220px_at_16%_0%,rgba(99,168,255,0.12),rgba(255,255,255,0)_66%),linear-gradient(180deg,rgba(255,255,255,0.9),rgba(255,255,255,0.78))] p-4 shadow-[0_12px_30px_rgba(15,23,42,0.07)] sm:p-5 [@media(max-height:820px)]:p-3">
          {/* Hero logo */}
          <div className="flex justify-center">
            <div className="relative h-[122px] w-[122px] sm:h-[142px] sm:w-[142px] [@media(max-height:820px)]:h-[106px] [@media(max-height:820px)]:w-[106px]">
              <Image
          ...
          {/* Copy */}
          <div className="mt-3 text-center [@media(max-height:820px)]:mt-2.5">
        ...
        <div className="mt-4 rounded-[24px] border border-blue-100/60 bg-[radial-gradient(560px_220px_at_15%_0%,rgba(99,168,255,0.10),rgba(255,255,255,0)_66%),rgba(255,255,255,0.76)] p-3.5 shadow-[0_12px_30px_rgba(15,23,42,0.07)] sm:p-4 [@media(max-height:820px)]:mt-3.5 [@media(max-height:820px)]:p-3">
