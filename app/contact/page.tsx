...
export default function ContactPage() {
  ...
  return (
    <SiteChrome>
      <PageTemplate>
        {/* Header stays always visible (clean hierarchy) */}
        ...
        <div className="relative mt-6">
          {/* Normal view */}
          {!sent && <ContactForm variant="contact" onSuccess={() => setSent(true)} />}

          {/* Success overlay – covers the full “content area” (under header) */}
          {sent && (
            <div className="relative overflow-hidden rounded-[22px] border border-emerald-200/70 bg-emerald-50/80 p-6 shadow-sm backdrop-blur-xl">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 max-w-[34ch] text-[15px] leading-6 text-slate-700">
                  Thanks! We’ve received your message and will reply by email within{" "}
                  <span className="font-medium">24–48 hours</span>.
                </p>

                <p className="mt-4 text-[13px] text-slate-600">
                  You can safely close this page — or tap <span className="font-medium">X</span> to send another message.
                </p>
              </div>
            </div>
          )}
