      ...
      <section className="mx-auto min-h-screen w-full max-w-[1040px] px-4 pt-24 pb-20 sm:px-6 sm:pt-28">
        ...
        <div className="mt-6 space-y-7">
          ...
          <section id="my-library-owned" className="space-y-4">
            <h2 className={sectionHeadingClass}>Owned library items</h2>
              ...
              <div className="fs-library-card fs-library-card-muted border-dashed p-5 sm:p-6">
                ...
                <div className="mt-4 border-t border-[color:var(--fs-border-soft)] pt-4">
                  <p className="text-xs leading-relaxed text-[color:var(--fs-color-muted)]">
                    Already bought with another email? Request an access link and we&apos;ll restore
                    your library when you sign in.
                  </p>
                  <DownloadResendForm
          ...
          <section id="my-library-explore" className="space-y-4">
            <h2 className={sectionHeadingClass}>Explore available items</h2>
            <div className="grid gap-3 sm:grid-cols-2">
