...
export const MOBILE_NAV_SHELL =
  "rounded-[22px] bg-white/94 p-2 shadow-[0_5px_14px_rgba(15,23,42,0.07)] ring-1 ring-slate-200/58 backdrop-blur";
...
export const MOBILE_NAV_SKIN_NEUTRAL =
  "bg-white/92 text-slate-900 ring-1 ring-slate-200/65 shadow-[0_2px_5px_rgba(15,23,42,0.055)]";

export const MOBILE_NAV_SKIN_ACTIVE =
  "bg-gradient-to-b from-blue-500 to-blue-600 text-white shadow-[0_2px_6px_rgba(37,99,235,0.12)]";
...
export const MOBILE_NAV_SEGMENT_ROW = "flex items-center gap-1 rounded-[18px] bg-slate-100/82 p-1";
