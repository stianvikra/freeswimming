...
const BUTTON_GUIDE: ActionGroup[] = [
  {
    ...
    actions: [
      ...
      },
      {
        ...
        meaning:
          "`Lesson experience layout` sets the all-lesson container preset before section editing. `Shown on lesson page` fields follow the public lesson order and wording. Use each section's single visibility control for public visibility, and use inline `Show safety note` controls to hide caution copy without deleting it. `Admin/list only` keeps Summary separate for search and lists. Advanced/fallback fields keep stable IDs, support actions, and older technical fallback content separate from the main authoring flow.",
      },
      {
        label: "Open preview",
        meaning:
