...
test("sitemap contains canonical public routes", async ({ request }) => {
  ...
  expect(xml).toContain("<loc>https://freeswimming.org/en/course</loc>");
  expect(xml).toContain(
    "<loc>https://freeswimming.org/en/course/course-module-introduction-to-the-course/course-lesson-introduction-to-the-course-welcome-course-structure</loc>"
  );
  ...
  expect(xml).not.toContain("<loc>https://freeswimming.org/course</loc>");
