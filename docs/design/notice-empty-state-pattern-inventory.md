...
| Habits feedback                     | `components/my-library/habits/HabitPerfectDayHub.tsx`                                                                                                                                                                                    | schema warning, action error, action success, create notice, first-run/no-active empty state                                                                   | Fresh `2026-05-24` re-audit found Habits still using repeated route-local feedback markup after Profile, Goals, My Training, Dryland, and export feedback semantics shipped.                                                                                                                                                               | Active slice: standardize Habits feedback semantics without changing habit data, APIs, cadence, timers, check-ins, analytics, navigation, Help/Guide, or support behavior.                |
