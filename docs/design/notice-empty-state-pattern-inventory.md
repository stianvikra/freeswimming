...
| Course support card                            | `app/course/page.tsx`, `tests/e2e/course-support-card-actions.spec.ts`                                                                                                                                                                                                                                                                                                                  | `Need extra help?`, support action links, configured primary support action, Open-on-phone utility placement                                                                                                                                                                                              | Fresh `2026-05-29` re-audit found the `/course` support card still using route-local rounded card/action styling while adjacent Course backup prompt, Menu Drawer, My Library, auth, and guide surfaces now use the newer AW-006 token/action hierarchy.                                                                                                                                                                                                                                                                                                                                                                             | In progress: `docs/task-briefs/in-progress/2026-05-29-aw-006-course-support-card-token-action-parity-10-10.md`; preserve course content, support action mapping, support action hrefs/labels/order, QR/share/copy behavior, progress, auth, analytics, Help/Guide, and support procedures. |
