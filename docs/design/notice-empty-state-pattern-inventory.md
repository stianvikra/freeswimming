...
| Admin messages                                 | `components/admin/AdminMessagesManager.tsx`                                                                                                                                                                                                                                                                                                                                             | warning, error, notice, action error, loading list, no matches, no selection, shell, search/source/status filters, stored-request rows, selected-message detail, diagnostics, delivery attempts, workflow actions, delete confirmation, load older                                                        | The second-wave state primitive pass is complete, but a fresh `2026-05-30` re-audit after Email Templates token/action parity found the Messages shell, filters, list/detail panels, diagnostics, delivery attempts, and visible workflow actions still using older local rounded `slate`/`blue` styling while the admin shell and adjacent managers now use the AW-006 token/action direction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Active: `docs/task-briefs/in-progress/2026-05-30-aw-006-admin-messages-manager-token-action-parity-10-10.md`; preserve message data, filters, status transitions, One.com inbox behavior, APIs, authz, Help/Guide, email delivery, and support procedures.                             |
