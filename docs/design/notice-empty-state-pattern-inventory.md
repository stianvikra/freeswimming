...
| Public policy and QR fallback pages            | `app/privacy/page.tsx`, `app/cookies/page.tsx`, `app/go/unavailable/page.tsx`                                                                                                                                                                                                                                                                                                           | privacy/cookie policy sections, processor rows, retention rows, QR fallback reason copy, safe retry, course/support exits                                                                                                                                                                                 | Fresh `2026-06-01` re-audit found these public trust/support pages still using older route-local rounded cards and button styles while adjacent recovery, member, guide, and admin surfaces now use the newer AW-006 token/card/action hierarchy. Owner review added two mobile rules: avoid a single orphan action alone on the final row; when one clear primary exists, render it full-width above two equal secondary actions on mobile while keeping desktop compact; compact fallback cards should use panel-scale mobile headings rather than hero-scale type.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Active: `docs/task-briefs/in-progress/2026-06-01-aw-006-public-policy-qr-fallback-token-action-parity-10-10.md`; preserve policy meaning, metadata, QR fallback safety, support/course links, APIs, auth, analytics, Help/Guide, support behavior, heading scale, and action hierarchy intent. |
