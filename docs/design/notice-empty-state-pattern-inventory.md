...
| Guide access required state         | `app/guides/0-1000m/page.tsx`, `app/guides/poolside/page.tsx`                                                                                                                                                                            | signed-in no-entitlement state, `View plans`, `Back to My Library`                                                                                              | Fresh 2026-05-26 re-audit found duplicated older "Guide access required" cards on both guide routes that are not yet aligned with the newer AW-006 card/action/state direction.                                                                                                                                                            | In progress: `docs/task-briefs/in-progress/2026-05-26-aw-006-guide-access-required-state-parity-10-10.md`; preserve auth redirects, entitlement checks, guide content loading, guide PDF routes, trackers, checkout, analytics, Help/Guide, and support behavior. |
