...
| Admin notes/content managers                   | `components/admin/AdminNotesManager.tsx`, `components/admin/AdminContextNotesPanel.tsx`, `components/admin/AdminContentManager.tsx`                                                                                                                                                                                                                                                     | loading, warning, errors, recovery warnings, upload retry, empty, no matches, audit mode, focus mode, mirror snapshot, QA cleanup utility states                                                                                                                                                          | Dense, high-value operator workflows with staged uploads, related records, and recovery behavior. Admin Notes top-level, Context Notes, and Content Manager top-level/revision/course-workspace/inline/course-structure feedback parity are done. Fresh `2026-05-29` re-audit selected a bounded `AdminContentManager` utility-state parity slice for audit-mode, focus-mode, platform mirror, and QA cleanup utility surfaces.                                                                                                                                                                                                      | Active: `docs/task-briefs/in-progress/2026-05-29-aw-006-admin-content-manager-utility-state-parity-10-10.md`; preserve content APIs, course structure behavior, authz, Context Notes/QR, labels, Help/Guide, support procedures, analytics, and data contracts.                        |
