...
| Install app prompt feedback         | `app/course/page.tsx`, `components/MenuDrawer.tsx`, `components/install/install-context.tsx`                                                                                                                                             | native prompt accepted/dismissed, already installed, unsupported browser, iOS instructions, Mac Safari instructions                                             | Fresh `2026-05-25` re-audit found course and main-menu install-app feedback still rendered as local plain text/instruction panels while adjacent route-owned feedback surfaces now use clearer accessible feedback contracts.                                                                                                              | Active: `docs/task-briefs/in-progress/2026-05-25-aw-006-install-app-prompt-feedback-semantics-10-10.md`; preserve install detection, native prompt behavior, local prompt cadence, app manifest, service worker, analytics, Help/Guide, and support behavior. |
