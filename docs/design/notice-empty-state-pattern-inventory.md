...
| AI Session Generator feedback       | `components/my-library/generator/GeneratorIntakeHub.tsx`, `components/my-library/generator/SessionGeneratorPanel.tsx`                                                                                                                    | draft recovery, stale-source warning, generator-intake load error, workout load error, selected-workout missing, save-unavailable warning, action error/success | Fresh `2026-05-25` re-audit found repeated generator-local feedback markup while adjacent member builder, goals, training, habits, and export surfaces now have clearer accessible feedback contracts.                                                                                                                                     | Active slice: standardize generator-local feedback semantics without changing generator data, APIs, workout saves, editor behavior, analytics, routes, Help/Guide, or support procedures. |
