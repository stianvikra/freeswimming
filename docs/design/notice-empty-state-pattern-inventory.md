...
| My Swim Sessions builder feedback   | `components/my-library/workouts/WorkoutBuilderHub.tsx`                                                                                                                                                                                   | schema warning, load error, action error, action success, local-draft recovery, first-run empty, selected-workout missing, no-loaded-session guidance          | Fresh `2026-05-25` re-audit found repeated local feedback markup in the My Swim Sessions builder while adjacent member surfaces now have clearer accessible feedback contracts.                                                                                                                                                            | Selected active slice: standardize builder-local feedback semantics without changing workout data, APIs, local drafts, export/PDF behavior, editor behavior, analytics, routes, Help/Guide, or support procedures. |
