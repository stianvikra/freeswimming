...
| Workout Editor exports and handoff  | `components/my-library/workouts/WorkoutEditor.tsx`                                                                                                                                                                                       | standard PDF open, Poolside PDF open, Garmin-ready JSON download, handoff copy/download success and errors                     | Fresh post-`#826/#827` re-audit found these export/handoff outcomes still render as plain route-local text while Program Builder, Guide PDF, and Poolside image export have mature accessible feedback references.                                                                                                                         | Active AW-006 slice: improve feedback semantics only, preserving workout data, artifact payloads, filenames, adapter behavior, popup behavior, Poolside preview rendering, and persistence. |
...
## Active Workout Editor Export And Handoff Feedback Semantics Slice
...
`docs/task-briefs/in-progress/2026-05-24-aw-006-workout-editor-export-handoff-feedback-semantics-10-10.md`
