...
| Admin notes/content managers                   | `components/admin/AdminNotesManager.tsx`, `components/admin/AdminContextNotesPanel.tsx`, `components/admin/AdminContentManager.tsx`                                                                                                                                                                                                                                                     | loading, warning, errors, recovery warnings, upload retry, empty, no matches, contextual note shell/actions, audit mode, focus mode, mirror snapshot, QA cleanup utility states                                                                                                                           | Dense, high-value operator workflows with staged uploads, related records, and recovery behavior. Admin Notes top-level, Context Notes, and Content Manager top-level/revision/course-workspace/inline/course-structure feedback parity are done. PR `#898/#899` closed the bounded `AdminContentManager` utility-state parity slice for audit-mode, focus-mode, platform mirror, and QA cleanup utility surfaces. Fresh `2026-05-31` re-audit found `AdminContextNotesPanel` still using older local rounded blue/slate/rose panel, field, row, attachment, and action styling while adjacent admin managers now use the newer AW-006 token/action hierarchy.                                                                                                                                                                                                                                                                                                 | Active: `docs/task-briefs/in-progress/2026-05-31-aw-006-admin-context-notes-panel-token-action-parity-10-10.md`; preserve note APIs, context filters, image upload/retry/delete behavior, authz, labels, Help/Guide, support procedures, analytics, and data contracts.                |
