...
| Admin note screenshot capture                  | `components/admin/AdminNoteScreenshotCaptureButton.tsx`                                                                                                                                                                                                                                                                                                                                 | permission denied, cancelled, unsupported, capture error, preview save error, trigger action, dialog shell, preview panels, crop controls, visible actions                                                                                                                                                | Small admin notes utility surface with focused unit coverage; PR `#804` moved scoped recovery/save-error feedback to the admin-local helper. Active `2026-05-31` AW-006 slice aligns the trigger, dialog shell, preview panels, crop controls, and visible actions with the current admin token/action hierarchy.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Active: `docs/task-briefs/in-progress/2026-05-31-aw-006-admin-note-screenshot-capture-token-action-parity-10-10.md`; preserve capture, crop, upload handoff, attachment, recovery, API/auth, labels, Help/Guide, and support behavior.                                                 |
