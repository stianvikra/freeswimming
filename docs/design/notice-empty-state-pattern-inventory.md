...
| Course progress sync                | `app/course/page.tsx`, `components/course/CourseProgressSyncStatus.tsx`                                                                                                                                                                  | signed-in sync idle/syncing/synced/error, retry, guest local-only progress, preview local-only progress                                                        | Fresh `2026-05-24` re-audit found `/course` has existing `courseSyncStatus` and retry behavior, but visible copy is tucked into overview details while guide trackers now have a clearer sync-status reference.                                                                                                                            | Active: route-local Course Progress Sync Status Clarity slice, preserving course progress API, storage keys, lesson identity, auth, analytics, course content, player behavior, and broad primitive boundaries. |
...
## Active Course Progress Sync Status Clarity Slice
...
`docs/task-briefs/in-progress/2026-05-24-aw-006-course-progress-sync-status-clarity-10-10.md`
