...
| Course progress backup prompt                  | `app/course/page.tsx`, `tests/e2e/install-prompt.spec.ts`                                                                                                                                                                                                                                                                                                                               | guest completed-lesson account-backup prompt, `Create free account`, `Maybe later`, dismissal cooldown                                                                                                                                                                                                    | Fresh `2026-05-28` re-audit found the `/course` guest progress backup prompt still using older radial-gradient card and emerald local action styling while auth, checkout, My Library, guide, and install-feedback surfaces now use the newer AW-006 token/action hierarchy.                                                                                                                                                                                                                                                                                                                                                         | Active: `docs/task-briefs/in-progress/2026-05-28-aw-006-course-backup-prompt-token-action-parity-10-10.md`; preserve course completion, local progress storage, backup threshold, dismissal behavior, sign-in next path, progress sync, install prompt behavior, analytics, Help/Guide, and support behavior. |
