...
| Program Builder route and exports   | `components/my-library/programs/ProgramBuilderHub.tsx`                                                                                                                                                                                                                                                | schema warning, load error, missing scheduled workouts, save error/success, no-loaded-program guidance, Garmin-ready JSON preview/download, Program PDF open status, download/open errors | PR `#826` closed the bounded export gap by adding accessible pending/success/error feedback for Program Builder JSON/PDF export actions while preserving program data, export routes, artifact formats, filenames, auth, persistence, and planner behavior. Fresh `2026-05-26` re-audit found route-level Program Builder feedback still rendered as local cards while export feedback already provides a mature local reference. | Selected active slice: `docs/task-briefs/in-progress/2026-05-26-aw-006-program-builder-route-feedback-semantics-10-10.md`; keep scope presentation-only and preserve program data, save payloads, week/day assignment behavior, export behavior, analytics, Help/Guide, and support behavior. |
