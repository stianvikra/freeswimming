...
| Workout editor inner step surface              | `components/my-library/workouts/WorkoutEditor.tsx`, `components/my-library/workouts/SessionStepSurfaceRenderer.tsx`, `components/my-library/workouts/sessionStepSurfaceContract.ts`                                                                                                                                                                                                     | metadata/current actions, inline PDF actions, save/discard/delete actions, `Edit`/`Rearrange`/`View` tabs, add step/repeat actions, undo/delete confirmations, rearrange controls, mobile step/repeat actions                                                                                                                               | Fresh `2026-06-02` re-audit after PR `#941/#942` found the builder entry/current-action shell aligned, while the inner `WorkoutEditor` and shared `SessionStepSurfaceRenderer` still used older local rounded slate/blue/rose action styling. The active slice aligns presentation with current AW-006 My Library token/action direction while preserving workout data, session-step behavior, local drafts, save/delete/discard behavior, exports, Poolside preview, analytics, Help/Guide, and support behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Active: `docs/task-briefs/in-progress/2026-06-02-aw-006-workout-editor-inner-token-action-parity-10-10.md`; future editor actions should reuse `fs-library-card` and `fs-cta-*`, while new destructive/export-adjacent/workflow-changing actions require explicit mapping, tests, and screenshot evidence.           |
