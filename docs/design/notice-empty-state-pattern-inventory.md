...
| Goals feedback                      | `components/my-library/goals/GoalsHub.tsx`                                                                                                                                                                                               | offline notice, action error + retry, action success, first-run empty goals, filtered no-results                               | Fresh `2026-05-24` re-audit found Goals still uses repeated local feedback/empty-state markup while adjacent member/profile/dryland/export surfaces now have clearer accessible feedback contracts.                                                                                                                                        | Current slice: standardize Goals feedback semantics without changing goal data, APIs, filters, active-limit logic, My Training links, analytics, or support procedures.                   |
