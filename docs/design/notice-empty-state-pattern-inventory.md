...
No AW-006 state-primitive implementation candidate is selected after `#800`.

Before selecting another slice, run a fresh queue/design/code re-audit from clean `main` and create or refresh the bounded task brief for the chosen surface.
