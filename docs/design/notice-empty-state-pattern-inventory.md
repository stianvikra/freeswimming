...
| My Swim Profile inner section forms               | `components/my-library/profile/AthleteProfileHub.tsx`, `tests/unit/athlete-profile-hub.test.tsx`, `tests/unit/design-token-contract.test.ts`, `app/globals.css`                                                                                                                                                                                                                         | profile form fields/actions, CSS fields/actions, training preference fields/checklists/actions, best-time rows and add/edit form, advanced generator-limit controls, section feedback, destructive row action token                                                                                                                         | Fresh `2026-06-03` queue/design/code re-audit after PR `#963/#964` found `AthleteProfileHub` inner section fields, best-time rows/forms, generator-limit controls, and visible save/reset/edit/delete actions still using older route-local rounded/slate/blue classes after the route shell and top readiness panel had already moved to the My Library token/action direction. Owner screenshot review then identified Delete needing systemic danger semantics, so the active slice adds shared `fs-cta-danger` beside `fs-cta-primary`/`fs-cta-secondary` and applies it to the scoped My Swim Profile destructive row action instead of keeping a local rose-only button.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Active: `docs/task-briefs/in-progress/2026-06-03-aw-006-my-swim-profile-inner-section-token-input-parity-10-10.md`; preserve profile data, APIs, local drafts, section order, readiness scoring, validation, analytics, Help/Guide, support behavior, and route shell behavior. Future profile sections/field types/actions require explicit mapping, tests, and screenshot evidence. Future app-wide Delete/Remove/Discard migration requires a separately selected slice. |
