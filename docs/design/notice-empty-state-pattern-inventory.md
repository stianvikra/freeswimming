...
| My Routines workspace               | `app/my-library/routines/page.tsx`, `components/my-library/TodayTabsPanel.tsx`                                                                                                                                                           | Micro Sessions and Habits tabs, setup/syncing/error/ready/complete/paused routine states, `Edit`, `Open`                                                        | Fresh `2026-05-25` re-audit found the dedicated `/my-library/routines` workspace still using older rounded blue-card and local tab styling after the top-level My Library hub moved to the newer token/action hierarchy.                                                                                                                   | In progress: `docs/task-briefs/in-progress/2026-05-25-aw-006-my-routines-workspace-token-action-parity-10-10.md`; preserve `TODAY_SURFACE_TABS`, `TodaySurfaceState`, habits/dryland data, API routes, localStorage, navigation, analytics, Help/Guide, and support behavior. |
