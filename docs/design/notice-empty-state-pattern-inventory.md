...
| My Library hub empty/member cards              | `components/my-library/MyLibraryHub.tsx`                                                                                                                                                                                                                                                                                                                                                | top-level member dashboard, resume/new-content entry, workspace cards, owned/explore empty-ish cards, commerce/account guidance                                                                                                                                                                                                             | PR `#758/#759` polished the route-local token hierarchy. Fresh `2026-06-02` re-audit after PR `#953/#954` found the smaller token/action gaps closed but `/my-library` still read as a flatter long card list on desktop, while AW-006 still records dashboard and desktop-native hierarchy as future-slice material. The selected follow-up is bounded to desktop value hierarchy and mobile regression safety, not new data or commerce behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Active: `docs/task-briefs/in-progress/2026-06-02-aw-006-my-library-dashboard-desktop-value-hierarchy-10-10.md`; preserve member data, product/catalog sections, auth redirects, checkout/portal/claim behavior, analytics instrumentation, child route contracts, Help/Guide, support behavior, and mobile scan order.                                                                                                              |
