...
| ---------------- | ------------ | ------------------------------------ | ------------------------- | ---------------------- | -------------------- | ----------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-07 07:38 | `preview`    | Codex automation                     | `smtp_one_com_compatible` | present                | present              | present           | partial | Preview env present, Preview redeploy ready, Supabase migrations applied, `/api/contact` returned `200`, and latest message/delivery status is `accepted_by_provider`; full admin workflow smoke still pending. |
| 2026-05-07 07:38 | `production` | Codex via `vercel env ls production` | `smtp_one_com_compatible` | present                | present              | present           | pending | Production env present, but Production redeploy and smoke are still pending.                                                                                                                                    |
