...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Product goals and IA                          | Clear user jobs, page purpose, and navigation hierarchy by route.                                                                                                                     | Goal and IA for changed routes documented in brief.                                                              |
...
| Business logic correctness and data integrity | Deterministic state transitions, explicit invariants, idempotent critical mutations, and no silent data corruption.                                                                   | Invariants for changed flows are documented and covered by tests and/or runtime guards.                          |
...
| Stack-fit and dependency discipline           | Use stack-native patterns first; shared React/view-model contracts, typed validation, Supabase/RLS discipline, official SDK patterns, minimal dependency growth, and clear contracts. | No unnecessary dependency added without explicit rationale; impacted stack surfaces are identified in the brief. |
