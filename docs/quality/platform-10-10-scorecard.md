...
| Stack-fit and dependency discipline           | Use stack-native patterns first; minimal dependency growth and clear contracts.                                     | No unnecessary dependency added without explicit rationale.                             |
