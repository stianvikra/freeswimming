...
| Admin content/editorial           | `lib/admin/content*`, admin content route tests, `AdminContentManager`                   | Admin workspace, content manager, content parity E2E                                                                                                                                   | Mature and well tested; component size is the main drift risk                                                              | `docs/task-briefs/planned/2026-05-05-admin-workspace-contract-decomposition-10-10.md`                        |
...
2. Admin workspace contract decomposition.
   ...
   - Owner: `docs/task-briefs/planned/2026-05-05-admin-workspace-contract-decomposition-10-10.md`.
