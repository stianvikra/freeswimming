...
- `reason`: Official Garmin docs confirm Training API is the workout/training-plan publish path and Activity API is the received-activity path. Provider-evidence boundary/schema foundation now exists, but partner approval, credentials, swim mapping signoff, provider correlation/alias behavior, brand/attribution requirements, and provider test evidence are not available in the repo.
...
- `2026-06-22 | provider-evidence boundary linked | refreshed after Review Actual Editor V1 PR #1203 and closeout PR #1204; linked docs/task-briefs/done/2026-06-22-provider-evidence-boundary-and-reconciliation-intake-v1-10-10.md as the provider-evidence docs/schema-intake prerequisite before any received-activity matching can depend on send-job aliases or payload fingerprints | next: keep Training API runtime blocked until Garmin partner/API access, swim mapping, provider evidence boundary, and alias/correlation behavior are concrete`
- `2026-06-22 | provider-evidence schema linked | refreshed after Provider Evidence Schema Foundation V1 PR #1206 and closeout PR #1207; provider-evidence boundary/schema is now available for future received-activity evidence, and docs/task-briefs/done/2026-06-22-provider-evidence-fixture-import-v1-10-10.md can prove bounded fixture writes before real provider runtime; Training API send remains blocked until Garmin partner/API access, swim mapping, credentials, attribution, and alias/correlation behavior are concrete`
- `2026-06-22 | provider-evidence fixture linked | refreshed after Provider Evidence Fixture Import V1 PR #1209, closeout PR #1210, and roadmap refresh PR #1211; disabled-by-default manual_fixture provider-evidence writes are now proven separately from completion truth, but Training API send remains blocked until Garmin partner/API access, swim mapping, credentials, attribution, and alias/correlation behavior are concrete`
- `2026-06-22 | provider roadmap lock | refreshed after Provider Evidence Boundary Intake, Schema Foundation, and Fixture Import V1 all moved to done; Training API send remains blocked because Garmin partner/API access, swim mapping, credentials, attribution, and alias/correlation behavior are still not concrete | next: keep this brief blocked`
