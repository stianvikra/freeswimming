...
- `2026-06-22 | provider-evidence schema linked | refreshed after Provider Evidence Schema Foundation V1 PR #1206 and closeout PR #1207; provider-evidence boundary/schema is now available for future received-activity evidence, and docs/task-briefs/planned/2026-06-22-provider-evidence-fixture-import-v1-10-10.md can prove bounded fixture writes before real provider runtime; Training API send remains blocked until Garmin partner/API access, swim mapping, credentials, attribution, and alias/correlation behavior are concrete`
