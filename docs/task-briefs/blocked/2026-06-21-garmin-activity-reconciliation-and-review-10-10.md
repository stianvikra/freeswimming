...
- `reason`: Official Garmin docs confirm Activity API can provide detailed activity data, but FreeSwimming does not yet have completed swim history, Garmin send jobs, credentials, consent flow, provider samples, or a reviewed match/edit workflow.
...
- Compare sent-vs-received evidence where available:
  ...
  - intended workout ID/payload fingerprint vs received activity,
  - sport/sub-sport,
