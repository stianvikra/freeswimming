...
| -------- | -------------------------------------------------------------------------------------------------------- | ---------------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1        | `docs/task-briefs/planned/2026-06-18-admin-shell-mobile-discoverability-and-quick-note-context-10-10.md` | `a4677939`, `89eacfbc` | `bounded implementation child`   | Highest current whole-admin blocker: mobile exposes only about `3/11` admin tabs, and the Quick note context warning can be clarified without data model changes. |
| 2        | `docs/task-briefs/planned/2026-06-18-admin-content-mirror-and-status-action-density-10-10.md`            | `a4677939`             | `bounded implementation child`   | Keeps Content-specific mirror/status action density out of the shell nav slice.                                                                                   |
| 3        | `docs/task-briefs/planned/2026-06-18-course-lesson-coach-check-and-action-clarity-followups-10-10.md`    | `63d7037f`, `46eae589` | `bounded implementation child`   | Public lesson UX follow-up; needs screenshot parity and owner review.                                                                                             |
...
Recommended next implementation candidate after owner audit approval: `admin-shell-mobile-discoverability-and-quick-note-context`.
