...
| `833d64f7-0a8e-4f78-916c-71a321cd96e4` | `Indicate New Messages in Menu on Messages with Icon and number? when new messages are present?` | `course_lesson:breathing-and-floating--floating-back`                                                      | Active Messages indicator child selects `Needs reply` active-message count, not an unread/new count.                                                 |
