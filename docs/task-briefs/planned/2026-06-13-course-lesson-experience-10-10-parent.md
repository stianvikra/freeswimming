...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [Lesson Experience V1 Pedagogical Layout And Fallback Data](/Users/stianvikra/freeswimming/docs/task-briefs/in-progress/2026-06-13-course-lesson-experience-v1-pedagogical-layout-fallback-data-10-10.md) | `in-progress` | Prove the new lesson skeleton with optional fields, old-field fallbacks, one representative existing lesson, tests, and screenshot handoff.    |
| [Course Lesson Experience Admin Editor](/Users/stianvikra/freeswimming/docs/task-briefs/in-progress/2026-06-13-course-lesson-experience-admin-editor-10-10.md)                                            | `in-progress` | Make the new pedagogical text fields and practice image slots editable, governable, previewable, and rollback-safe in admin content workflows. |
...
| Content/admin governance | Current admin course editor maps core fields only; new pedagogical fields and practice images need a separate admin editor child before a full platform 10/10 claim.           | high     | bounded implementation child   | no                       | `docs/task-briefs/in-progress/2026-06-13-course-lesson-experience-admin-editor-10-10.md`                    |
