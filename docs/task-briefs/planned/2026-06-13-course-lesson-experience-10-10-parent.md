...
- `reason`: Main is clean after PR `#1122` and closeout PR `#1123`; Course Lesson Experience V1, admin editor, public visual quality, mark-as-done progress behavior, and analytics/KPI interpretation are merged and closed, leaving admin/public field parity and view-change ergonomics as the next bounded child before PRO, SEO/canonical routes, distribution, media-production, health-check, template, or live-preview expansion.
...
| [Course Lesson Admin/Public Field Parity And View Changes V1](/Users/stianvikra/freeswimming/docs/task-briefs/in-progress/2026-06-14-course-lesson-admin-public-field-parity-and-view-changes-v1-10-10.md) | `in-progress` | Reorder and relabel course lesson admin create/edit fields to match the public lesson flow, add video/time editing, add `View changes`, and separate Summary plus advanced/fallback fields.           |
