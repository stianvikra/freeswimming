...
- `reason`: Main is clean after PR `#1124` and closeout PR `#1125`; Course Lesson Experience V1, admin editor, public visual quality, mark-as-done progress behavior, analytics/KPI interpretation, and admin/public field parity are merged and closed, leaving one real admin lesson-production run as the next bounded learning child before PRO, SEO/canonical routes, distribution, media-production, health-check, template, live-preview, or legacy-cleanup expansion.
...
| [Course Lesson Analytics And KPI Interpretation V1](/Users/stianvikra/freeswimming/docs/task-briefs/done/2026-06-14-course-lesson-analytics-kpi-interpretation-v1-10-10.md)                         | `done`        | Added privacy-safe event mapping, dashboard interpretation, and support-safe diagnostics for lesson completion, continuation, and post-value interest.                                                |
| [Course Lesson Admin/Public Field Parity And View Changes V1](/Users/stianvikra/freeswimming/docs/task-briefs/done/2026-06-14-course-lesson-admin-public-field-parity-and-view-changes-v1-10-10.md) | `done`        | Reordered and relabeled course lesson admin create/edit fields to match the public lesson flow, added video/time editing, added `View changes`, and separated Summary plus advanced/fallback fields.  |
| [Course Lesson Real Content Friction Fixes V1](/Users/stianvikra/freeswimming/docs/task-briefs/in-progress/2026-06-14-course-lesson-real-content-friction-fixes-v1-10-10.md)                        | `in-progress` | Apply the concrete public/admin UX fixes found while building one real lesson, then stop at screenshot handoff before PR gates.                                                                       |
| [Course Lesson Legacy Field Cleanup And Migration V1](/Users/stianvikra/freeswimming/docs/task-briefs/planned/2026-06-14-course-lesson-legacy-field-cleanup-and-migration-v1-10-10.md)              | `planned`     | Audit old lesson JSON keys and public fallback reads, then decide keep/migrate/remove per field with migration, tests, and rollback evidence before deleting any legacy data contract.                |
| Course Lesson Coach Yourself Prompt Layer V1                                                                                                                                                        | `future`      | Decide whether lessons should include 2-3 self-coaching questions derived from Goal, Feel cues, Common mistakes, and Pass criteria; avoid a generic body-part checklist that duplicates focus fields. |
...
- `2026-06-14 | analytics child closed and next planned child created | after PR #1122 merged as ef37b27e and closeout PR #1123 merged as 595e9a64, recovery confirmed clean synced main; created planned child docs/task-briefs/planned/2026-06-14-course-lesson-admin-public-field-parity-and-view-changes-v1-10-10.md for admin/public lesson field parity, video/time editing, View changes, Summary fallback clarity, and Advanced/fallback grouping; implementation is not approved yet | next: owner scope review/approval before implementation starts`
- `2026-06-14 | admin/public parity child in-progress | owner approved scope with "scope godkjent"; child moved to docs/task-briefs/in-progress/2026-06-14-course-lesson-admin-public-field-parity-and-view-changes-v1-10-10.md on branch task/course-lesson-admin-public-field-parity-v1; screenshot handoff required before verify:pre-pr | next: complete scoped implementation and targeted validation`
- `2026-06-14 | admin/public parity screenshot checkpoint | child implementation reached screenshot handoff: admin lesson editor now follows public lesson order, video/time fields are editable, Summary is separated as admin/list fallback, Advanced/fallback fields hold legacy/technical controls, Help/Guide and tests are updated, and screenshots were captured at output/course-lesson-admin-public-field-parity-2026-06-14-100945 using a temporary local visual harness that was removed before handoff | next: wait for owner screenshot approval before verify:pre-pr and PR flow`
- `2026-06-14 | legacy cleanup child planned | owner clarified that legacy course lesson keys should not be deleted inside the admin/public parity UI slice even though there are no users/finished lessons yet; created docs/task-briefs/planned/2026-06-14-course-lesson-legacy-field-cleanup-and-migration-v1-10-10.md as the dedicated future migration/removal slice, while the active parity child only hides legacy visibility controls from admin UI and preserves public fallback reads | next: finish active parity child and use cleanup child only after explicit future selection`
- `2026-06-14 | admin/public parity post-feedback screenshot checkpoint | active child now puts structured `Show section` controls on each optional public section, removes legacy visibility groups from Advanced, keeps legacy content fields/fallback reads, links the cleanup child from source and parent, and refreshed screenshot artifacts at output/course-lesson-admin-public-field-parity-2026-06-14-121558 | next: owner screenshot approval before verify:pre-pr and PR flow`
- `2026-06-14 | admin/public parity visual mirror checkpoint | active child now also mirrors the public lesson layout more closely: combined Lesson focus card, practice media placeholders in the public media position, Pass criteria/Next step desktop pair, clear public/admin/advanced badges, and refreshed screenshot artifacts at output/course-lesson-admin-public-field-parity-2026-06-14-130600 | next: owner screenshot approval before verify:pre-pr and PR flow`
- `2026-06-14 | coach-yourself prompt idea parked | owner asked whether coach-yourself questions like legs/arms/head position would improve lessons or duplicate focus items; decision for this active child is to defer and only consider a later prompt layer if questions are derived from existing Goal, Feel cues, Common mistakes, and Pass criteria rather than added as a generic checklist | next: continue active admin/public parity PR gates`
