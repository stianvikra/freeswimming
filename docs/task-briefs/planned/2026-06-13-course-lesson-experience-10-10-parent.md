...
| [Course Lesson Mark-as-done Progress Behavior](/Users/stianvikra/freeswimming/docs/task-briefs/in-progress/2026-06-13-course-lesson-mark-as-done-progress-behavior-10-10.md)                       | `in-progress` | Harden the existing lesson completion state machine, pass-criteria gate, undo, and guest/signed-in progress sync behavior.                   |
...
| Course progress behavior | `Mark as done` now needs a dedicated stateful child because it spans pass criteria, local progress, signed-in sync, undo, backup/install prompts, and failure states.         | high     | bounded implementation child   | no                       | `docs/task-briefs/in-progress/2026-06-13-course-lesson-mark-as-done-progress-behavior-10-10.md` |
