...
- `2026-06-23 | prerequisites intake linked | refreshed after Garmin/provider data scope audit PR #1223 merged and prerequisites evidence fill PR #1225 shipped; linked docs/task-briefs/done/2026-06-23-garmin-provider-prerequisites-intake-10-10.md as the completed docs-only evidence-packet step before any Garmin/provider runtime brief | next: collect owner/provider facts or keep Garmin runtime blocked`
