...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped AW-006 follow-ups through `#868` are recorded below, and no active AW-006 implementation slice remains selected after this repo-managed Guide Tracker Action Shell Token Parity closeout.
...
No AW-006 implementation slice is selected after the Guide Tracker Action Shell Token Parity closeout. Before selecting another slice, run a fresh queue/design/code re-audit and give the required non-programmer explanation.
