...
Current active implementation row: Guide Access Required State Parity.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Guide Access Required State Parity                        | `in-progress` | `docs/task-briefs/in-progress/2026-05-26-aw-006-guide-access-required-state-parity-10-10.md`                     | Owner-approved on 2026-05-26 and now executing after explicit instruction: align signed-in no-entitlement states on `/guides/0-1000m` and `/guides/poolside` with AW-006 card/action/state direction without changing entitlements, Stripe, Supabase, guide PDFs, trackers, checkout, analytics, Help/Guide, or support behavior. |
