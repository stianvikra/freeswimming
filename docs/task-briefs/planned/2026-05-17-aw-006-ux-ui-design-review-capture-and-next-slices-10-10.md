...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#848` are recorded below. PR `#847` shipped Course Open On Phone Feedback Semantics and repo-managed closeout PR `#848` left no active AW-006 implementation slice before the fresh queue/design/code re-audit selected Admin Email Template Preview Feedback Semantics.
...
PR `#847` shipped Course Open On Phone Feedback Semantics and repo-managed closeout PR `#848` left no active AW-006 implementation slice. A fresh queue/design/code re-audit selected Admin Email Template Preview Feedback Semantics as the next bounded admin feedback slice.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                                                                                 |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Admin Email Template Preview Feedback Semantics           | `in-progress` | `docs/task-briefs/in-progress/2026-05-25-aw-006-admin-email-template-preview-feedback-semantics-10-10.md`        | Fresh `2026-05-25` re-audit found create/edit preview JSON errors and missing preview values still rendering as local red/amber text while adjacent Email Templates states already use `AdminManagerState`; scope preserves template data, APIs, placeholder rendering, locales, workflow labels, Help/Guide, and support procedures. |
