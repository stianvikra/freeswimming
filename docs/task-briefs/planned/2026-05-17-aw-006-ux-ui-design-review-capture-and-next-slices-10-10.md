...
PR `#849` shipped Admin Email Template Preview Feedback Semantics. Repo-managed closeout `#850` left no active AW-006 implementation slice; a fresh queue/design/code re-audit selected the owner-approved Install App Prompt Feedback Semantics slice.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                                          |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Install App Prompt Feedback Semantics                     | `in-progress` | `docs/task-briefs/in-progress/2026-05-25-aw-006-install-app-prompt-feedback-semantics-10-10.md`                  | Selected after fresh `2026-05-25` queue/design/code re-audit: standardize course and main-menu install-app feedback semantics without changing PWA install detection, native prompt behavior, local prompt cadence, course progress, navigation, analytics, Help/Guide, or support procedures. |
