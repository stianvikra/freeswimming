...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped AW-006 follow-ups through `#862/#863` are recorded below, and this refresh selects Owned Library Item Detail Token And Action Parity for this implementation branch.
...
Current active implementation row: Owned Library Item Detail Token And Action Parity.

| Slice                                                     | Status   | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owned Library Item Detail Token And Action Parity         | `active` | `docs/task-briefs/in-progress/2026-05-26-aw-006-owned-library-item-detail-token-action-parity-10-10.md`          | Owner-approved current slice: align `/my-library/item/[slug]` with My Library token/action hierarchy while preserving entitlement checks, redirects, product action-copy mapping, analytics payloads, PDF download wiring, admin context notes, Help/Guide, and support behavior.  |
