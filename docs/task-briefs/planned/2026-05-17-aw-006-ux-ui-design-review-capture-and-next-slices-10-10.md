...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#836` are recorded below. PR `#836` shipped Habits Feedback Semantics, and this repo-managed closeout leaves no active AW-006 implementation slice selected.
...
PR `#836` shipped the selected Habits Feedback Semantics slice. This repo-managed closeout moves its brief to done and leaves no active AW-006 implementation slice selected until a future queue/design/code re-audit chooses one.
