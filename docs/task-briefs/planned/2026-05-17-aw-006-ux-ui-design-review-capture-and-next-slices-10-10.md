...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#824` are recorded below. Plans Comparison Purchase-Model Ready Card Parity shipped through `#824`, and this repo-managed closeout leaves no active AW-006 implementation slice selected.
...
PR `#824` shipped Plans Comparison Purchase-Model Ready Card Parity. This repo-managed closeout moves that brief to done and leaves no active AW-006 implementation slice selected.
