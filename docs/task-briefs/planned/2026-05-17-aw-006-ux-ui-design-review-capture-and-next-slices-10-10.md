...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through My Routines Workspace Token And Action Hierarchy Parity `#855` are recorded below. This repo-managed closeout moves the My Routines brief to done and clears stale lifecycle pointers; no new AW-006 implementation slice is selected.
...
Current active implementation row: none selected after My Routines closeout.
