...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#834/#835` are recorded below. A fresh queue/design/code re-audit on `2026-05-24` selected the approved Habits Feedback Semantics slice as the current bounded AW-006 implementation slice.
- `must_refresh_before_execution_if`: Refresh if AGENTS.md, scorecard categories, AW-006 scope, mobile nav, auth sign-in, course/player, plans/payment copy, `/about`, design tokens, admin state primitives, dryland routes/micro-session state contracts, `/my-library/goals`, goals API/storage contracts, `/my-library/habits`, habit API/storage contracts, task-brief closeout rules, forward compatibility rules, screenshot handoff rules, or verification lanes change before the current Habits slice finishes.
...
PR `#834` shipped the selected My Training Feedback Semantics slice, and repo-managed closeout PR `#835` left no active AW-006 slice. On `2026-05-24`, the owner approved `AW-006 Habits Feedback Semantics` after a fresh queue/design/code re-audit; that slice is now the active bounded implementation target.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                   |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Habits Feedback Semantics                                 | `in-progress` | `docs/task-briefs/in-progress/2026-05-24-aw-006-habits-feedback-semantics-10-10.md`                              | Standardize `/my-library/habits` schema/action/empty/create feedback semantics without changing habit data, APIs, cadence, timers, check-ins, analytics, navigation, Help/Guide, or support procedures.                                                 |
