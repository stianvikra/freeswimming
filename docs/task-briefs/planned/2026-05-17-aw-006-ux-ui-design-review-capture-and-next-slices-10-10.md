...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#822/#823` are recorded below. A fresh queue/design/code re-audit selected Plans Comparison Purchase-Model Ready Card Parity as the current bounded AW-006 implementation slice.
...
PR `#822` shipped Admin Quick Capture Feedback State Parity and repo-managed closeout PR `#823` left no active AW-006 slice. A fresh queue/design/code re-audit selected the next bounded `/plans` UI slice.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                 |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Plans Comparison Purchase-Model Ready Card Parity         | `in-progress` | `docs/task-briefs/in-progress/2026-05-23-aw-006-plans-comparison-purchase-model-ready-card-parity-10-10.md`      | Make `/plans` easier to compare and align product cards with the public token/card reference while preserving today's checkout behavior and avoiding permanent one-time purchase assumptions before future package/subscription work. |
