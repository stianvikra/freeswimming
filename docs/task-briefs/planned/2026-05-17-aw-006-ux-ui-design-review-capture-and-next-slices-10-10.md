...
PR `#845` shipped Manual Creation Entry Feedback Semantics and repo-managed closeout PR `#846` left no active AW-006 implementation slice selected. A fresh queue/design/code re-audit selected the approved next slice below.

| Slice                                                     | Status   | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Course Open On Phone Feedback Semantics                   | `active` | `docs/task-briefs/in-progress/2026-05-25-aw-006-course-open-on-phone-feedback-semantics-10-10.md`                | Selected after `#845/#846`: standardize `/course` Open on phone QR/copy/share feedback semantics without changing course content, lesson routing, QR generation, stable redirect behavior, progress sync, auth, analytics, Help/Guide, or support procedures.                      |
