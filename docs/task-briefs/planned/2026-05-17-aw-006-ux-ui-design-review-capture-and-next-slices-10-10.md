...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped follow-ups through `#849` are recorded below. PR `#849` shipped Admin Email Template Preview Feedback Semantics, repo-managed closeout `#850` cleared the queue, and the fresh queue/design/code re-audit selected the owner-approved Install App Prompt Feedback Semantics slice.
...
PR `#851` shipped Install App Prompt Feedback Semantics. This repo-managed closeout moves the brief to done and leaves no active AW-006 implementation slice selected.
