...
- `reason`: The original review lived only in chat after `main@be554e9`; shipped AW-006 follow-ups through `#866` are recorded below, and no active AW-006 implementation slice remains selected after the repo-managed My Swim Sessions Saved List Token And Action Parity closeout.
...
Implementation row after owner approval on 2026-05-26: `Guide Tracker Action Shell Token Parity` is the active AW-006 implementation slice.

| Slice                                                     | Status        | Evidence                                                                                                         | Notes                                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Guide Tracker Action Shell Token Parity                   | `in-progress` | `docs/task-briefs/in-progress/2026-05-26-aw-006-guide-tracker-action-shell-token-parity-10-10.md`                | Owner-approved after fresh queue/design/code re-audit: align entitled `/guides/0-1000m` and `/guides/poolside` route action strips and tracker shells with current AW-006 token/action direction while preserving entitlements, PDFs, progress sync, notes, fullscreen behavior, Help/Guide, and support behavior. |
