...
| Child C: Habits History And Insights                   | Habit details timeline, calendar/heatmap, date range/day-number labels, previous/next week swipe, selected-day behavior, backfill/edit previous days, notes per log, archive-keep-history, export/readability decisions.                                                                                                        | Timer behavior changes unless Child B owns them.                                                                        |
...
| H-009 | Satisfied for Child A/B/D | Child A, Child B, and Child D each refreshed Habits code, benchmark expectations, and data sufficiency before implementation; future children must repeat their own audit.                                                                                                                                                         |
| H-010 | Partially resolved        | PR `#977` covers rest/skip, consistency %, and current streak where data proves it; PR `#979` covers timer/manual/one-active-timer gaps; PR `#981` exposes the current week overview on mobile; backfill, best streak, habit score, deeper calendar/history, notes, archive history, sound, reminders, and export remain deferred. |
...
| H-018 | Partially resolved        | PR `#981` adds mobile access to the existing weekly/calendar overview; Child C still owns selecting prior days and backfill/edit-history behavior.                                                                                                                                                                                 |
...
| H-020 | Deferred                  | Child D only exposes today's existing weekly overview on mobile; week date labels, previous/next week swipe, selected-day behavior, and backfill edit rules belong to Child C History/Calendar.                                                                                                                                    |
