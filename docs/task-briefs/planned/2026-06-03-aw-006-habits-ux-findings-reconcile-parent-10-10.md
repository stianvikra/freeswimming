...
It closed additive manual time, single running timer behavior, and duplicate timer display cleanup while keeping sound out of the first pass.
...
| ----- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| H-001 | Resolved                    | PR `#979` shows today's timed total as saved server minutes plus the current local timer and makes manual time additive external time.                                                                                                                                                                                                                        |
| H-002 | Resolved                    | PR `#979` replaces unclear manual labels with `Manual time` and `Add manual time` copy on the timed habit detail surface.                                                                                                                                                                                                                                     |
