...
| H-019 | Resolved                    | PR `#985` closes Done-only/Any amount and existing safe count-unit setup; persisted `litres` remains future migration scope.                                                                                                                                                                                                                                  |
