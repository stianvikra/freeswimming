...
| Child F: Habits Builder Target Semantics               | Decide and implement target-entry options such as Done-only reminders, `Any amount`, litres/glasses/count units, validation copy, and support guidance for water-style habits.                                                                                                                                                  | History/backfill/calendar navigation, timer behavior, or broad card redesign.                                                                                                                                 |
...
Child C active slice: `docs/task-briefs/in-progress/2026-06-04-aw-006-habits-history-calendar-10-10.md` on branch `aw-006-habits-history-calendar`.

It scopes a thin shared My Library calendar source/date contract plus Habits selected-day history as the first consumer. It now includes ISO week number/year for week clarity while keeping week/month/year comparison in planned system-calendar follow-up `docs/task-briefs/planned/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md`. It should close H-018/H-020 only after screenshot approval, pre-PR gates, PR/CI/pre-merge, and closeout.
...
| H-018 | In progress in Child C      | PR `#981` adds mobile access to the existing weekly/calendar overview; active Child C owns selected-day history, previous/next week controls, and clear edit rules.                                                                                                                                                                                            |
| H-019 | Deferred                    | PR `#981` presents simple water reminders as Done-only in screenshot evidence; explicit `Any amount`, litres, and glasses builder semantics require a future builder target semantics child.                                                                                                                                                                   |
| H-020 | In progress in Child C      | Active Child C owns ISO week number/year, week date labels, previous/next week controls, selected-day behavior, and historical check-in edit rules while keeping global calendar storage and week/month/year comparison deferred to `docs/task-briefs/planned/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md`.                               |
...
- `2026-06-04 | in-progress | owner approved continuing with Child C after a product audit clarified that Freeswimming should create a thin shared My Library calendar contract first and use Habits as the first consumer, not build a full competing system calendar; active child is docs/task-briefs/in-progress/2026-06-04-aw-006-habits-history-calendar-10-10.md on branch aw-006-habits-history-calendar | next: implement focused selected-day/week history, run targeted validation, capture screenshot handoff, and stop for owner visual approval before npm run verify:pre-pr`
