...
| H-019 | In progress                 | PR `#985` closed Done-only/Any amount and existing safe count-unit setup; active Child H adds the persisted `litres` migration, typed mapping, UI option, formatter labels, tests, and support docs.                                                                                                                                                          |
