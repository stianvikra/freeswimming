...
| Future: My Library Calendar Period Comparison          | Planned system-calendar follow-up: `docs/task-briefs/planned/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md` for comparing weeks, months, and years using shared `source`, `period`, `range`, and `compareTo` concepts across Habits, Micro Sessions, Dryland, Swimming, and All.                                                                                                                                                                                                       | Active Child C selected-day/week correction, habit setup editing, swim/dryland/micro scheduling, global calendar storage without its own data-boundary decision.                                              |
...
| H-020 | Resolved                    | PR `#983` adds ISO week number/year, week date labels, previous/next week controls, selected-day behavior, and historical check-in edit rules while keeping global calendar storage and week/month/year comparison deferred to `docs/task-briefs/planned/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md`.                                 |
