...
| Child G: Habits Post-Merge Polish                      | In progress: `docs/task-briefs/in-progress/2026-06-04-aw-006-habits-post-merge-polish-10-10.md` for post-PR-985 polish: bounded `0-100` open count inputs, no duplicate open count `Value`/`Save` inside Details, and no-wrap desktop `Mark done` peer actions.                                                                                                                                                                                                                                           | Calendar comparison, persisted `litres`, midnight auto-complete, sound/preferences, advanced motivation, timer behavior, history/backfill, API/schema changes, or broad card redesign.                        |
...
| H-029 | In progress                 | Child G owns the explicit `0-100` open count input bound and `0` save behavior.                                                                                                                                                                                                                                                                             |
| H-030 | In progress                 | Child G owns removing duplicated open count `Value`/`Save` controls from Details when the row already exposes the editor.                                                                                                                                                                                                                                   |
| H-031 | In progress                 | Child G owns no-wrap desktop `Mark done` action layout.                                                                                                                                                                                                                                                                                                     |
| H-032 | In progress                 | Child G owns resyncing the visible Habits week/day when App Router history or week navigation provides a new server snapshot.                                                                                                                                                                                                                               |
| H-033 | In progress                 | Child G owns keeping desktop pills immediately after the habit heading where space allows.                                                                                                                                                                                                                                                                  |
| H-034 | In progress                 | Child G owns preventing open count `Save` and `Details` overlap/collision.                                                                                                                                                                                                                                                                                  |
| H-035 | In progress                 | Child G owns equal-height peer row controls across steppers, primary actions, and Details.                                                                                                                                                                                                                                                                  |
