...
| My Library Calendar Period Comparison                  | In progress: `docs/task-briefs/in-progress/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md` implements shared week/month/year comparison using `source`, `period`, `range`, and `compareTo` concepts across Habits, Micro Sessions, Dryland, Swimming, and All. Habits, Micro Sessions, and Dryland use existing canonical data; Swimming starts as not mapped until a completed-on date contract exists.                                                                                | Active Child C selected-day/week correction, habit setup editing, swim/dryland/micro scheduling, global calendar storage without its own data-boundary decision.                                              |
...
| H-020 | Resolved                    | PR `#983` adds ISO week number/year, week date labels, previous/next week controls, selected-day behavior, and historical check-in edit rules while global calendar storage remains deferred; week/month/year comparison is now active in `docs/task-briefs/in-progress/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md`.                  |
...
- `2026-06-05 | in-progress | owner explicitly selected My Library Calendar Period Comparison after PR #987/#988 closeout; active brief is docs/task-briefs/in-progress/2026-06-04-aw-006-my-library-calendar-period-comparison-10-10.md on branch aw-006-my-library-calendar-period-comparison; persisted litres, midnight auto-complete, audio/preferences, and Advanced Motivation remain separate owner-selected Habits decisions | next: finish calendar implementation, screenshot handoff, and return here before closeout`
