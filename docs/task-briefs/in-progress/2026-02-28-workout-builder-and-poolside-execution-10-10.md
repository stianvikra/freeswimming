...
- Current runtime implementation slice under this brief:
  ...
  - keep send-off/CSS-send-off authoring, broader custom pool-length entry, and poolside execution deferred while the richer step contract continues to stabilize.
