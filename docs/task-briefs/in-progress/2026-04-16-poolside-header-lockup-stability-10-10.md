...
| Admin editor ergonomics                       | `N/A`        | N/A because this slice does not change admin workflows or editing surfaces.                                                                           | explicit scope rationale                   | `N/A`             |
...
| Security and authz                            | `N/A`        | N/A because no auth, entitlement, or authorization rule changes in this branding-only slice.                                                          | explicit scope rationale                   | `N/A`             |
| Content governance and source of truth        | `supporting` | The brand lockup should reflect the existing chosen visual direction instead of introducing an ad hoc alternate.                                      | code review + design comparison            | `4/5`             |
