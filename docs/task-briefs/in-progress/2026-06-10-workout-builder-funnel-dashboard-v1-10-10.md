...
- `2026-06-10 | committed | implementation commit 0c0c2cb7 created with scoped dashboard/view-model/Help/docs/tests diff after green pre-pr gate | next: push branch, open PR, monitor CI, then run npm run verify:pre-merge before merge`
