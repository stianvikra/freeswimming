...
- `2026-03-31 | 432f715 | first full verify:pre-pr rerun on the committed tree hit transient desktop-chromium public-route ECONNRESET/disposed-context behavior around sitemap + soft-launch, isolated repro of those two specs passed, and a second fresh full verify:pre-pr run passed green (91 passed / 281 skipped) without code changes | next: push branch and open PR with flake note in validation summary`
