...
| Testing and QA automation                     | `target`     | Save-open behavior and per-lesson `Common mistakes` memory are covered by targeted regression tests aligned to the current UI contract.                                     | targeted e2e + verify gates         |
