...
- `2026-04-23 | validation | hardened the unrelated poolside save-image e2e probe against transient preview navigation/context reloads and verified npm run verify:pre-merge PASS (full lane: 107 passed, 343 skipped, no failures) | next: commit/push PR update and refresh merge-readiness evidence`
