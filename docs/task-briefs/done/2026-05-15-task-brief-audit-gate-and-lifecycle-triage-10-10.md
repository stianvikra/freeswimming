...
- `2026-05-15 | merged | PR #714 merged as 739f7c8 after green CI and local npm run verify:pre-merge PASS; owner approved a scoped post-merge closeout for this brief only, leaving older in-progress briefs untouched for separate audit | next: closeout PR moves this brief to done and runs docs-only gates`
