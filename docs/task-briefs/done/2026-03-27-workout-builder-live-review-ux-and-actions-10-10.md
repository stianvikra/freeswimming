...
- `2026-04-02` — child slice shipped through [2026-04-02-workout-builder-drill-kick-taxonomy-followup-10-10.md](/private/tmp/freeswimming-admin-notes-umbrella-reconcile-2026-04-03/docs/task-briefs/done/2026-04-02-workout-builder-drill-kick-taxonomy-followup-10-10.md) and merged in PR `#342`; this pass clarified step-taxonomy labels, applied deterministic kick/drill focus defaults only when the focus field was previously unset, and kept implied kick/drill tags from duplicating inside summaries.
