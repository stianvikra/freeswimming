...
- `2026-05-16`: PR #730 merged as `91d8081` after GitHub `verify`, `npm run verify:pre-pr`, and `npm run verify:pre-merge` passed on `f4f1a93`. Post-merge preflight surfaced this repo-managed docs-only closeout; moving the brief to `done`.
