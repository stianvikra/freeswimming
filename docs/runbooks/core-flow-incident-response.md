...
- `/my-library/generator`
  ...
  - confirm `/my-library/workouts` stays a list-first browse surface with `Create session` available there and no hidden editor mutation happening in the background,
